...
manifest={
    ...
    "continuous_evolution":"observe -> diagnose -> candidate-only development -> trusted-baseline strict no-regression comparison -> proof-gated promotion -> deploy -> observe",
    "evolution_judge":"baseline-pinned policy digest + protected constitutional paths; candidate cannot redefine its own acceptance function",
