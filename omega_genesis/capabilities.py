...
CAPABILITIES = [
    ...
    {"id":"CAP-024","name":"Deterministic Earth dataset provenance envelopes","menu":"09 World / Bio / Forecast","gate":"Source coverage + no-evidence boundary","status":"LIVE_CORE"},
]
