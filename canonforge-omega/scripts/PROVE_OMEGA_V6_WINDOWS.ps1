...
$foundationModelWeightsTrained = $false
if ($null -ne $acceptance.b059Verification.PSObject.Properties['foundationModelWeightsTrained']) {
...
$receipt = [ordered]@{
  ...
  b059 = [ordered]@{
    ...
    foundationModelWeightsTrained = $foundationModelWeightsTrained
  }
