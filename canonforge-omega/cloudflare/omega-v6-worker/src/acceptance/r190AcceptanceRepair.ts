...
function repairCapability(capability: Obj): Obj {
  ...
  // These routes delegate to the protected Sovereign authority. They are part of
  // full-system acceptance, but cloud-only quick acceptance must not require an
  // external PC/gateway to be online.
