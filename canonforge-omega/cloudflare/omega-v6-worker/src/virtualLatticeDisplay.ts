...
export const VISUAL_DELIVERY_BOUNDARY =
  "R149 adds an inspectable Intelligence route-to-generation workspace over the established R148 Memory, R147 calculus field and native 20,736 atlas. Intelligence reads the existing /api/omega/state authority and /api/route-preview contract, exposes governed mode, bounded forecast, proposed action and generation admission before /api/chat can run, and preserves route-before-generation. Runtime observations remain distinct from DERIVED_FRAMEWORK_MATH, SIMULATED_CONTINUATION, MODEL_OUTPUT and USER_DEFINED_MODEL geometry; UTC render time is not evidence time. It does not mutate canonical state beneath heartbeatTruth, preserves OmegaRuntime and Hybrid/Genesis authority boundaries, preserves representational 12^n shells, preserves the R143 device-DPR 3 quality contract as a compatibility capability, does not claim a physical 61.9-billion-pixel panel, and does not claim physical 20,736 dimensions.";
