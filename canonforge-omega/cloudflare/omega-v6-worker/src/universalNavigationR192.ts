...
.r192More{margin-left:auto;position:relative;flex:0 0 auto}.r192MenuButton{height:34px;border:1px solid #38516f;border-radius:9px;background:#0d1724;color:#eaf1fb;padding:0 10px;cursor:pointer;font:inherit}.r192Menu{position:absolute;right:0;top:40px;width:250px;display:none;padding:7px;border:1px solid #314864;border-radius:12px;background:#07101a;box-shadow:0 24px 70px #000b}.r192More.open .r192Menu{display:grid}.r192Menu a{padding:10px;border-radius:8px;color:#c4d0df!important}.r192Menu a:hover{background:#122136}.r192Menu small{display:block;color:#73869e;margin-top:2px;font-weight:600}
